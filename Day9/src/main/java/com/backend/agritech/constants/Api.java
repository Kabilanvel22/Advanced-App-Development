package com.backend.agritech.constants;
...
public class Api {
    ...
    public static final List<String> ORIGINS = Arrays.asList("http://localhost:3000","https://localhost:8080/swagger-ui/index.html");
}
